...
public partial class PedidosCompraDetalle
{
    ...
    public virtual PedidosCompraEstado Estado { get; set; }

    public virtual PedidosCompraDetalleCdbo IdcdboNavigation { get; set; }

    public virtual IsoPedidosCompraDetalle IsoPedidosCompraDetalle { get; set; }
