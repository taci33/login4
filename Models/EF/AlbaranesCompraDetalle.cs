...
public partial class AlbaranesCompraDetalle
{
    ...
    public virtual AlbaranesCompra Cabecera { get; set; }

    public virtual CtaCentroCoste CentroCoste { get; set; }

    public virtual ConceptosRetencion ConceptoRetencion { get; set; }

    public virtual AlbaranesCompraEstado Estado { get; set; }

    public virtual AlbaranesCompraDetalleCdbo IdcdboNavigation { get; set; }
