...
public partial class DevolucionesVentaDetalle
{
    ...
    public double CantidadDevolucionPrevista { get; set; }

    public double CantidadDevolucion { get; set; }
    ...
    public virtual DevolucionesVentum Cabecera { get; set; }

    public virtual CtaCentroCoste CentroCoste { get; set; }

    public virtual ConceptosRetencion ConceptoRetencion { get; set; }

    public virtual DevolucionesVentaEstado Estado { get; set; }

    public virtual DevolucionesVentaDetalleCdbo IdcdboNavigation { get; set; }

    public virtual ICollection<DevolucionesVentaDetalle> InverseLinea { get; set; } = new List<DevolucionesVentaDetalle>();
    ...
    public virtual DevolucionesVentaDetalle Linea { get; set; }
