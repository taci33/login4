...
public partial class AlbaranesVentum
{
    ...
    public bool DirRecogida { get; set; }

    public int? DirRecogidaEntidadOrigenId { get; set; }

    public int? DirRecogidaKeyFieldValueId { get; set; }

    public int? DirRecogidaDireccionId { get; set; }
    ...
    public DateTime? EmailSentFenvio { get; set; }
    ...
    public virtual DireccionesEntidadesOrigen DirRecogidaEntidadOrigen { get; set; }
    ...
    public virtual AlbaranesVentaEstado Estado { get; set; }

    public virtual AlbaranesVentaCdbo IdcdboNavigation { get; set; }
