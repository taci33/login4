...
public partial class AlqAlquilere
{
    ...
    public virtual ICollection<AlqAlquileresDetallePicking> AlqAlquileresDetallePickings { get; set; } = new List<AlqAlquileresDetallePicking>();
    ...
    public virtual AlqAlquileresCdbo IdcdboNavigation { get; set; }
