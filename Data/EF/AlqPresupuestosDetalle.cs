...
public partial class AlqPresupuestosDetalle
{
    ...
    public virtual AlqPresupuesto Cabecera { get; set; }
    ...
    public virtual AlqPresupuestosDetalleCdbo IdcdboNavigation { get; set; }

    public virtual ICollection<AlqPresupuestosDetalle> InverseLinea { get; set; } = new List<AlqPresupuestosDetalle>();
    ...
    public virtual AlqPresupuestosDetalle Linea { get; set; }
