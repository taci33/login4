...
public partial class PedidosVentaDetalle
{
    ...
    public virtual PedidosVentaDetalleCdbo IdcdboNavigation { get; set; }

    public virtual ICollection<PedidosVentaDetalle> InverseLinea { get; set; } = new List<PedidosVentaDetalle>();
    ...
    public virtual PedidosVentaDetalle Linea { get; set; }
