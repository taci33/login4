...
public partial class FacturasVentum
{
    ...
    public int? CentroAdministrativoId { get; set; }
    ...
    public string ExentaCausa { get; set; }
    ...
    public virtual FacturasVentaEstado Estado { get; set; }

    public virtual FacturasVentum FacturaRectificada { get; set; }
    ...
    public virtual FacturasVentaCdbo IdcdboNavigation { get; set; }

    public virtual ICollection<FacturasVentum> InverseFacturaRectificada { get; set; } = new List<FacturasVentum>();
