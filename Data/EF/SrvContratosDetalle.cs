...
public partial class SrvContratosDetalle
{
    ...
    public virtual SrvContratosDetalleCdbo IdcdboNavigation { get; set; }

    public virtual ICollection<SrvContratosDetalle> InverseLinea { get; set; } = new List<SrvContratosDetalle>();
    ...
    public virtual SrvContratosDetalle Linea { get; set; }
