...
public partial class PresupuestosCompraDetalle
{
    ...
    public virtual PresupuestosCompra Cabecera { get; set; }
    ...
    public virtual PresupuestosCompraDetalleCdbo IdcdboNavigation { get; set; }
