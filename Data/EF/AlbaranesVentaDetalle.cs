...
public partial class AlbaranesVentaDetalle
{
    ...
    public virtual AlbaranesVentum Cabecera { get; set; }
    ...
    public virtual AlbaranesVentaDetalleCdbo IdcdboNavigation { get; set; }

    public virtual ICollection<AlbaranesVentaDetalle> InverseLinea { get; set; } = new List<AlbaranesVentaDetalle>();
    ...
    public virtual AlbaranesVentaDetalle Linea { get; set; }
