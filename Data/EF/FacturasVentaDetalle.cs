...
public partial class FacturasVentaDetalle
{
    ...
    public virtual FacturasVentum Cabecera { get; set; }
    ...
    public virtual FacturasVentaDetalleCdbo IdcdboNavigation { get; set; }

    public virtual ICollection<FacturasVentaDetalle> InverseLinea { get; set; } = new List<FacturasVentaDetalle>();
    ...
    public virtual FacturasVentaDetalle Linea { get; set; }
